...
@interface ZZEvaluationTVC ()

@end

@implementation ZZEvaluationTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZZEvaluationCell *cell = [tableView dequeueReusableCellWithIdentifier:evaluationCelldentifier forIndexPath:indexPath];
