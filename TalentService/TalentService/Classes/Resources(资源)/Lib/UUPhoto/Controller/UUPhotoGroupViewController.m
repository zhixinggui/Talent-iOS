...
- (void)configUI{
    ...
    [[UUAssetManager sharedInstance] getGroupList:^(NSArray *obj) {
        ...
        UUPhotoCollectionViewController *photoCollectionVC = [[UUPhotoCollectionViewController alloc]init];
        photoCollectionVC.group = [[UUAssetManager sharedInstance]  getGroupAtIndex:[UUAssetManager sharedInstance].currentGroupIndex];
        [self.navigationController pushViewController:photoCollectionVC animated:NO];
    }];
}
