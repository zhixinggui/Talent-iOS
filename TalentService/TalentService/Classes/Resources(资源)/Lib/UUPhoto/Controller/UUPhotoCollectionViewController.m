...
- (void)configNavigationItem{
    ...
    [self  setNavTitleString:[self.group valueForProperty:ALAssetsGroupPropertyName]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    controller.origin = self.toolBarView.origin;
...
- (UICollectionView *)getCollectionView{
    ...
    if (!_collectionView) {
        ...
        CGRect frame = CGRectMake(0, 5, ScreenWidth, CGRectGetHeight(self.view.frame) -55);
