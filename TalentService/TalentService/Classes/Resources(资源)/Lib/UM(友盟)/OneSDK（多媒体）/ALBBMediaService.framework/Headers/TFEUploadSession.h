...
//由tae sdk返回的url，上传成功之后有
@property(nonatomic, strong, readonly) NSString *responseDir;
@property(nonatomic, strong, readonly) NSString *responseBody;
@property(nonatomic, strong, readonly) NSString *responseCustomBody;
@property(nonatomic, strong, readonly) NSString *responseName;
//文件的md5值
